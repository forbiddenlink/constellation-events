        ...
        <nav className="hidden md:flex items-center gap-1 rounded-full bg-white/5 p-1">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className={`rounded-full px-4 py-1.5 text-xs font-medium transition-[background-color,color,box-shadow] hover:bg-white/10 hover:text-white hover:shadow-lg ${
